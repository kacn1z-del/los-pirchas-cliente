...
export default function SocialLinks() {
  return (
    <footer className="social-footer">
      <p className="social-footer__title">Pedidos y contacto</p>
      <div className="social-footer__icons">
        ...
        >
          <svg viewBox="0 0 24 24" width="30" height="30" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
      ...
      <a href={whatsappLink()} target="_blank" rel="noreferrer" className="social-footer__phone">
      ...
      <p className="social-footer__meta">San Luis, Acosta · Diagonal a Unifami</p>
    </footer>
  )
}
